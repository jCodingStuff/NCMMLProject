...
env = GridworldMultiAgentv3(gridsize=5, nb_agents=2, nb_resources=2, screen=screen, debug=True)
...
# Load weights
dqn.load_weights(get_agent_path('dqn30_5b5_3216_adam_lr0.001_tmu0.01_ml50K_ns5M_eps0.1_a6_b0'))
