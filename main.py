...
env = GridworldMultiAgentv15(gridsize=5, nb_agents=2, nb_resources=2, screen=screen, debug=True)
...
# Load weights
dqn.load_weights(get_agent_path('dqn15_5b5_3236_adam_lr0.001_tmu0.01_ml50K_ns7M_eps0.1'))
